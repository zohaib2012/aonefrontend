                  ...
                  >
                    ...
                    <td className="p-3 whitespace-nowrap">
                      <div className="flex flex-col sm:flex-row gap-2">
                        <button
                          onClick={() =>
                            navigate("/profile/wallet/deposit/method")
                          }
                          className="bg-[#253333] text-[#00B894] px-3 py-1 rounded text-sm w-full sm:w-auto"
                        >
                          Fund
                        </button>

                        <button
                          onClick={() => navigate("/profile/trade")}
                          className="bg-[#253333] text-[#00B894] px-3 py-1 rounded text-sm w-full sm:w-auto"
                        >
                          Trade
                        </button>
          ...
          {accounts.length > 0 ? (
            accounts.map((account, index) => (
              ...
              >
                ...
                <div className="flex gap-2 pt-2">
                  <button
                    onClick={() => navigate("/profile/wallet/deposit/method")}
                    className="bg-[#253333] text-[#00B894] px-3 py-1 rounded w-full"
                  >
                    Fund
                  </button>
                  <button
