...
const Easypaisaaccount = () => {
    ...
    const handleCopyAll = () => {
        const textToCopy = `A/c no: 03257205412
  Bank: Easypaisa/Telenor bank
        ...
        <div>
            <div className="w-full lg:w-full p-1 ">
                <div className="w-full max-w-md  rounded-lg mx-2 space-y-1 ">
                    ...
                    <div className="space-y-4 ">
                        ...
                        <div className="bg-[#3C3C3C] border-2 border-gray-600 rounded-lg p-4 space-y-3">
                            <div className="flex justify-between">
                                ...
                                <span>03257205412</span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-gray-400">Bank</span>
                                <span>Easypaisa/Telenor bank</span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-gray-400">Name</span>
                                <span>Shahab Uddin Khan</span>
                            </div>
                            <div className="flex justify-between">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold">
                            2.           Make a payment using your Easypaisa app or visit a nearby Easypaisa shop

                        </h2>
                        <div className="bg-yellow-600/20 text-yellow-400 p-3 rounded-lg text-sm">
                            <p>
                                •  Please carefully note the Easypaisa Account Number and Payment Reference during your transfer to ensure your payment is correctly processed.

                            </p>
                            <p className="mt-2">
                                •  If the details provided are incorrect, your deposit may be delayed or rejected. Aone Pro reserves the right to request additional information and/or supporting documents for verification.
