      ...
      <div className="w-full max-w-4xl border-2 border-gray-600 flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="hidden lg:block w-1/3 border-r border-gray-600">
          ...
          <div className="divide-y divide-gray-600">
            ...
            {/* <div
              className={`p-2 flex items-center cursor-pointer hover:bg-[#3C3C3C] ${selectedMethod === "ep" ? "bg-[#1E1E1E]" : ""
                }`}
            ...
            <div
              className={`p-2 flex items-center cursor-pointer hover:bg-[#3C3C3C] ${selectedMethod === "jz" ? "bg-[#1E1E1E]" : ""
                }`}
